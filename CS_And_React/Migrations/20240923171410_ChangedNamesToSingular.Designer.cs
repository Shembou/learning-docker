...
namespace Site_Api.Migrations
{
    ...
    [Migration("20240923171410_ChangedNamesToSingular")]
    partial class ChangedNamesToSingular
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Site_Api.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            Password = "AQAAAAIAAYagAAAAEOYoe+cfiBr9i0decM2JsWJie6SAU1Ri6ZnKMZ6Uox+kcCR19SiKvkLEQ26L1gqFGQ==",
                            UserName = "Przemas"
                        });
                });
