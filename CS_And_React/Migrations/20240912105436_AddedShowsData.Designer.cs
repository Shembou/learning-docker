...
namespace Site_Api.Migrations
{
    ...
    [Migration("20240912105436_AddedShowsData")]
    partial class AddedShowsData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Site_Api.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            Password = "AQAAAAIAAYagAAAAEI7F14LAELGxVPZkTqMRIQfqG2JZ7ce0IDtFGSlxLlVxFR9+qQ/fxxjLogx2n2kWPQ==",
                            UserName = "Przemas"
                        });
                });
